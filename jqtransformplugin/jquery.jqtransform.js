...
(function($){
  ...
  ***************************/
  var jqTransformGetLabel = function(objfield){
	...
	oLabel = objfield.next(), inputname;
    if(!oLabel.is('label')) {
  ...
  $.fn.jqTransInputText = function(){
    return this.each(function(){
      var $input = $(this), oLabel, inputSize, $wrapper;
  ...
  $.fn.jqTransCheckBox = function(){
    return this.each(function(){
      var $input = $(this), oLabel, aLink = $('<a href="#" class="jqTransformCheckbox"></a>');

      if($input.hasClass('jqTransformHidden')) {
	  return;
      }
  ...
  $.fn.jqTransRadio = function(){
    return this.each(function(){
      var $input = $(this), inputSelf = this, aLink = $('<a href="#" class="jqTransformRadio" rel="'+ inputSelf.name +'"></a>');
  ...
  $.fn.jqTransTextarea = function(){
    return this.each(function(){
      var textarea = $(this), strTable = '<table cellspacing="0" cellpadding="0" border="0" class="jqTransformTextarea">', oTable;
  ...
  $.fn.jqTransSelect = function(){
    if (this.length) {
      this.each(function(index){
        var $select = $(this), oLabel, $wrapper, $ul, oLinkOpen, iSelectWidth, oSpan, newWidth, hidden_containers, iSelectHeight;
	...
	/* First thing we do is Wrap it */
        ...
        oLinkOpen.click(function(){
            ...
            var already_open = $ul.is(':visible'), $clone;
